                    ...
                    <tr key={course.id} className="hover:bg-slate-50/50 transition-colors group">
                      ...
                      <td className="p-4 pr-6 text-right">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <Link href={`/admin/courses/${course.id}/analytics`} className="p-2 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors" title="Course Analytics">
                            <BarChart2 size={16} />
                          </Link>
                          <button 
