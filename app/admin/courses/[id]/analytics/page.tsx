      ...
      <div className="max-w-6xl mx-auto space-y-6 pb-12">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2 text-sm text-slate-500">
            <Link href="/admin/courses" className="hover:text-teal-600 transition-colors flex items-center gap-1">
              <ArrowLeft size={14} /> Courses
            </Link>
            <ChevronRight size={14} />
            <Link href={`/admin/courses/${id}/enrollments`} className="hover:text-teal-600 transition-colors truncate max-w-[200px]">
              {course.title}
            </Link>
            <ChevronRight size={14} />
            ...
            <div className="relative pt-4 bg-slate-50/50 rounded-xl border border-slate-100 p-4">
              <div className="h-56 w-full flex items-end relative">
                ...
                <svg viewBox="0 0 700 220" className="w-full h-full z-10 overflow-visible">
                  <defs>
                    <linearGradient id="tealGradAdmin" x1="0" y1="0" x2="0" y2="1">
                  ...
                  {MOCK_STUDENTS_LEADERBOARD.map((student, idx) => (
                    <tr key={student.id} className="hover:bg-slate-50/30 transition-colors group">
                      ...
                      <td className="p-4 pr-6 text-right">
                        <Link 
                          href={`/admin/courses/${id}/enrollments/${student.id}`} 
