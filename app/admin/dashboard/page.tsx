            ...
            <div className="rounded-2xl bg-white p-5 shadow-sm border border-slate-200">
              ...
              <div className="h-32 flex flex-col items-center justify-center bg-slate-50 rounded-xl">
                ...
                <div className="flex gap-4 mt-2">
                  <span className="text-[10px] text-slate-500">🔵 School 40%</span>
                  <span className="text-[10px] text-slate-500">🟢 UG 45%</span>
                  <span className="text-[10px] text-slate-500">🟡 PG 15%</span>
                </div>
              </div>
            </div>
