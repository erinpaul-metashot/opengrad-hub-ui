      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={idx} className="rounded-2xl bg-white p-5 shadow-sm border border-slate-200 flex flex-col justify-between hover:scale-[1.01] transition-all">
              <div className="flex justify-between items-start">
                <div className={`p-2.5 rounded-xl ${kpi.bg} ${kpi.color} mb-4`}>
                  <kpi.icon size={20} />
                </div>
            ...
            <div className="relative pt-4 bg-slate-50/50 rounded-2xl border border-slate-100 p-4 overflow-x-auto">
              <div className="h-60 min-w-[600px] flex items-end relative">
                ...
                <svg viewBox="0 0 700 220" className="w-full h-full z-10 overflow-visible">
                  <defs>
                    <linearGradient id="growthTealGradMgr" x1="0" y1="0" x2="0" y2="1">
                  ...
                  {/* Current Period Area */}
                  <path d={currentArea} fill="url(#growthTealGradMgr)" />
            ...
            <div className="grid grid-cols-3 gap-3.5 mt-4 border-t border-slate-100 pt-3">
              {[
                ...
                <div 
                  ...
                  onMouseLeave={() => setHoveredSlice(null)}
                >
                  <span className={`w-2/5 h-2 rounded-full ${item.color} mb-1.5`}></span>
